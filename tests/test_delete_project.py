...
@pytest.mark.asyncio
async def test_delete_project_with_tasks_soft_delete_tasks_and_soft_delete_project() -> (
    None
):
    project_repository = InMemoryProjectRepository()
    task_repository = InMemoryTaskRepository()
    ...
    delete_task_use_case = DeleteTaskUseCase(task_repository=task_repository)
